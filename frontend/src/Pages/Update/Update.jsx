            ...
            <form onSubmit={createStory} className="flex flex-col  gap-5 shadow-[0_0_10px_gray] rounded-lg p-5 w-full md:w-1/2">
                <div className="flex flex-col  items-start justify-between gap-5">
                    <div  className="flex flex-col items-center gap-5 w-full">
                        <label htmlFor="avatar" className=""><img className="w-full md:w-36 rounded-sm" src={previewImage ? URL.createObjectURL(previewImage) :`${url}/images/${story.image}`} alt="" /></label>
